...
import { Box,Center,Button,Input,useToast,Modal } from 'native-base'
...
function UserProfile(props) {
    ...
    // const [username] = useState((props.auth.user && props.auth.user.username)|| '')
    ...
    const updateHandler = async() =>{
        ...
        try {
            const response = await axios({
                url: 'https://rootrsk-security-api.herokuapp.com/user/profile',
                method:'PATCH',
                data:{
            ...
            {props.auth && props.auth.user && 
                <Box margin='auto' w='95%' maxWidth={'500px'} mt='5' >
                    ...
                    >   
                       ...
                       {imageUrl &&  <img src={imageUrl} alt="" width='100px' height={'100px'} />}
                    </Box>
